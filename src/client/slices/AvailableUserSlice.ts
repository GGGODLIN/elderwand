...
const clear = AvailableUserSlice.actions.clear as ActionCreatorWithoutPayload<string>;
const fetch = AvailableUserSlice.actions.fetch as ActionCreatorWithPayload<PaginationVM<UserVM>, string>;
const push = AvailableUserSlice.actions.push as ActionCreatorWithPayload<UserVM[], string>;
const remove = AvailableUserSlice.actions.remove as ActionCreatorWithPayload<key[], string>;

const selectRow = AvailableUserSlice.actions.selectRow as ActionCreatorWithPayload<key, string>;
const deselectRow = AvailableUserSlice.actions.deselectRow as ActionCreatorWithPayload<key, string>;
const selectAllRows = AvailableUserSlice.actions.selectAllRows as ActionCreatorWithoutPayload<string>;
const deselectAllRows = AvailableUserSlice.actions.deselectAllRows as ActionCreatorWithoutPayload<string>;

const setRangeStart = AvailableUserSlice.actions.setRangeStart as ActionCreatorWithPayload<{ key: key, checked: boolean }, string>;
const setRangeSelect = AvailableUserSlice.actions.setRangeSelect as ActionCreatorWithPayload<key, string>;
