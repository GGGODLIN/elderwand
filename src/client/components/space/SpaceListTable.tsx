...
const SpaceListTable: React.FC<SpaceListTableProp> = (props) => {
  ...
  const rows = !root
    ...
    : [root]
        ...
        .map((space) => (
          <SpaceTableRow key={space.id} rowData={space} spaces={props.spaces} />
        ));
      ...
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            ...
            {/* Selected */}
            <TableCell className={"selected"}>{checked_list_count}</TableCell>
            <TableCell className={"name"}>{"Name"}</TableCell>
            <TableCell className={"device-count"}>{"Device Count"}</TableCell>
            <TableCell className={"fe-count"}>{"Engineer Count"}</TableCell>
            <TableCell className={"icon-path"}>{"Icon Path"}</TableCell>
...
const SpaceTableRow: React.FC<SpaceTableRowProps> = (props) => {
  ...
  const handleCheck = (e: ChangeEvent<HTMLInputElement>, checked: boolean) => {
